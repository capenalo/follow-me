...
class PointsControllerTest < ActionController::TestCase
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post :create, point: { address: @point.address, city: @point.city, country: @point.country, location: @point.location, name: @point.name }
    end
  ...
  test "should update point" do
    patch :update, id: @point, point: { address: @point.address, city: @point.city, country: @point.country, location: @point.location, name: @point.name }
    assert_redirected_to point_path(assigns(:point))
  end
